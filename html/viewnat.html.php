...
switch($type) {
  case 1: /* NAT */ ?>
		  ...
		  <?=$enat->description;?>
                  ...
                  <td valign="middle" class="list" nowrap> <a href="natmod.php?mid=<?=$mono->id;?>&type=<?=$type;?>&nid=<?=$enat->id;?>"><img src="img/e.gif" title="edit rule" width="17" height="17" border="0"></a>
                     &nbsp;<a href="natrm.php?mid=<?=$mono->id;?>&type=<?=$type;?>&nid=<?=$enat->id;?>" onclick="return confirm('Do you really want to delete this rule?')"><img src="img/x.gif" title="delete rule" width="17" height="17" border="0"></a></td>
				</tr>
			  <?php $i++; endforeach; ?>
                <tr> 
                  <td class="list" colspan="6"></td>
                  <td class="list"> <a href="natmod.php?mid=<?=$mono->id;?>&type=<?=$type;?>"><img src="img/plus.gif" title="add rule" width="17" height="17" border="0"></a></td>
				</tr>
              </table><br>
  ...
  <table width="80%" border="0" cellpadding="0" cellspacing="0">
			  ...
			  <?php $i = 0; foreach ($mono->srvnat as $snat): ?>
                <tr> 
                  ...
                  <td class="list" nowrap> <a href="natmod.php?mid=<?=$mono->id;?>&type=<?=$type;?>&nid=<?=$snat->id;?>"><img src="img/e.gif" title="edit entry" width="17" height="17" border="0"></a>
                     &nbsp;<a href="natrm.php?mid=<?=$mono->id;?>&type=<?=$type;?>&nid=<?=$snat->id;?>" onclick="return confirm('Do you really want to delete this entry?')"><img src="img/x.gif" title="delete entry" width="17" height="17" border="0"></a></td>
				</tr>
			  <?php $i++; endforeach; ?>
                <tr> 
                  <td class="list" colspan="2"></td>
                  <td class="list"> <a href="natmod.php?mid=<?=$mono->id;?>&type=<?=$type;?>"><img src="img/plus.gif" title="add entry" width="17" height="17" border="0"></a></td>
				</tr>
              </table><br>
			        <span class="vexpl"><span class="red"><strong>Note:<br>
...
<?php
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
		  ...
		  <?=$onat->if;?>
                  ...
                  <td class="listr"> 
		  <?=$onat->external;?><?php if ($onat->subnet) echo "/".$onat->subnet; ?>
                  </td>
                  <td class="listr"> 
		  <?=$onat->internal;?><?php if ($onat->subnet) echo "/".$onat->subnet; ?>
                  </td>
                  <td class="listbg"> 
		  <?=$onat->description;?>
                  </td>
                  <td class="list" nowrap> <a href="natmod.php?mid=<?=$mono->id;?>&type=<?=$type;?>&nid=<?=$onat->id;?>"><img src="img/e.gif" title="edit mapping" width="17" height="17" border="0"></a>
                     &nbsp;<a href="natrm.php?mid=<?=$mono->id;?>&type=<?=$type;?>&nid=<?=$snat->id;?>" onclick="return confirm('Do you really want to delete this mapping?')"><img src="img/x.gif" title="delete mapping" width="17" height="17" border="0"></a></td>
				</tr>
			  <?php $i++; endforeach; ?>
                <tr> 
                  <td class="list" colspan="4"></td>
                  <td class="list"> <a href="natmod.php?mid=<?=$mono->id;?>&type=<?=$type;?>"><img src="img/plus.gif" title="add mapping" width="17" height="17" border="0"></a></td>
				</tr>
              </table><br>
			  	<span class="vexpl"><span class="red"><strong>Note:<br>
...
<table width="100%" border="0" cellpadding="6" cellspacing="0">
		<form action="viewnat.php" method="POST">
		  ...
		  <?=$anat->source;?>
                  ...
                  <td class="listr"> 
		  <?php if($anat->dnot) echo "! "; ?><?=$anat->destination;?>
                  </td>
                  <td class="listr"> 
		  <?=$anat->target;?><?php
                      if ($anat->noportmap)
		  ...
		  <?=$anat->description;?>
                  ...
                  <td class="list" nowrap> <a href="natmod.php?mid=<?=$mono->id;?>&type=<?=$type;?>&nid=<?=$anat->id;?>"><img src="img/e.gif" title="edit mapping" width="17" height="17" border="0"></a>
                     &nbsp;<a href="natrm.php?mid=<?=$mono->id;?>&type=<?=$type;?>&nid=<?=$anat->id;?>" onclick="return confirm('Do you really want to delete this mapping?')"><img src="img/x.gif" title="delete mapping" width="17" height="17" border="0"></a></td>
                </tr>
              <?php $i++; endforeach; ?>
                <tr> 
