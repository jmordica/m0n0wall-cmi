              ...
              <table width="100%" border="0" cellpadding="6" cellspacing="0">
                  ...
                  <td width="78%" class="vtable">
					<select name="interface" class="formfld">
						...
						<option value="<?=$iface;?>" <?php if ($iface == $nat->if) echo "selected"; ?>>
						<?=$iface;?> (<?=htmlspecialchars($ifacename);?>)
						</option>
						<?php endforeach; ?>
					</select><br>
    	        ...
    	        <tr> 
                  ...
                  <td width="78%" class="vtable"> 
                    <select name="extaddr" class="formfld">
                      ...
                      <option value="<?=$sn->ipaddr;?>" <?php if ($sn->ipaddr == $nat->external) echo "selected"; ?>><?=htmlspecialchars("{$sn->ipaddr} ({$sn->description})");?></option>
                ...
                <tr> 
                  ...
                  <td width="78%" class="vtable"> 
                    <select name="proto" class="formfld">
                      ...
                      <option value="<?=strtolower($proto);?>" <?php if (strtolower($proto) == $nat->proto) echo "selected"; ?>><?=htmlspecialchars($proto);?></option>
                      <?php endforeach; ?>
		...
		<?php foreach ($wkports as $port => $value) { ?>
			...
			<?php foreach ($wkports as $port => $value) { ?>
                ...
                <tr> 
                  ...
                  <td width="78%" class="vtable"> 
                    <input name="localip" type="text" class="formfldalias" id="localip" size="20" value="<?=htmlspecialchars($nat->target);?>"> 
...
?>
                  ...
                  <td width="78%" class="vtable"> 
                    <select name="localbeginport" class="formfld" onChange="ext_change()">
                      <option value="">(other)</option>
                        ...
                        <?php } ?>
                    </select> <input name="localbeginport_cust" type="text" size="5" value="<?=$lport;?>"> 
                    <br>
                ...
                <tr> 
                  ...
                  <td width="78%" class="vtable"> 
                    <input name="descr" type="text" class="formfld" id="descr" size="40" value="<?=htmlspecialchars($nat->description);?>"> 
		  ...
		  <input name="type" type="hidden" value="<?=$type;?>">
                  ...
                  <input name="nid" type="hidden" value="<?=$nat->id;?>">
            ...
            <form action="natmod.php" method="post" name="iform" id="iform">
              <table width="100%" border="0" cellpadding="6" cellspacing="0">
                <tr> 
                  ...
                  <td width="78%" class="vtable"> 
                    <input name="ipaddr" type="text" class="formfld" id="ipaddr" size="20" value="<?=htmlspecialchars($nat->ipaddr);?>">
                    </td>
                </tr>
                <tr> 
                  <td width="22%" valign="top" class="vncell">Description</td>
            ...
            <form action="natmod.php" method="post" name="iform" id="iform">
              <table width="100%" border="0" cellpadding="6" cellspacing="0">
                ...
                <tr> 
                  ...
                  <td width="78%" class="vtable"> 
                    <input name="external" type="text" class="formfld" id="external" size="20" value="<?=htmlspecialchars($nat->external);?>">
                    / 
                    <select name="subnet" class="formfld" id="subnet">
                      <?php for ($i = 32; $i >= 0; $i--): ?>
                      <option value="<?=$i;?>" <?php if ($i == $nat->subnet) echo "selected"; ?>>
                      <?=$i;?>
                      </option>
                      <?php endfor; ?>
                    </select>
                ...
                <tr> 
                  ...
                  <td width="78%" class="vtable"> 
                    <input name="internal" type="text" class="formfld" id="internal" size="20" value="<?=htmlspecialchars($nat->internal);?>"> 
                    <br>
...
<?php $src = explode('/', $nat->source); ?>
					<input name="source" type="text" class="formfld" id="source" size="20" value="<?=htmlspecialchars($src[0]);?>">
                     
                  / 
                    <select name="source_subnet" class="formfld" id="source_subnet">
                      <?php for ($i = 32; $i >= 0; $i--): ?>
                      <option value="<?=$i;?>" <?php if (isset($src[1]) && $i == $src[1]) echo "selected"; ?>>
                      <?=$i;?>
                      </option>
                      <?php endfor; ?>
                    </select>
...
<?php if (strtolower($nat->destination) == "any") { $dst = ""; $dstn = ""; } else { $dsta = explode('/', $nat->destination); $dst = $dsta[0]; $dstn = isset($dsta[1])?$dsta[1]:""; } ?>
                        <td><input name="destination" type="text" class="formfld" id="destination" size="20" value="<?=htmlspecialchars($dst);?>">
                          / 
                          <select name="destination_subnet" class="formfld" id="destination_subnet">
                            <?php for ($i = 32; $i >= 0; $i--): ?>
                            <option value="<?=$i;?>" <?php if ($i == $dstn) echo "selected"; ?>> 
                            <?=$i;?>
                            </option>
                            <?php endfor; ?>
                          </select> </td>
                ...
                <tr> 
                  ...
                  <td class="vtable">
<input name="target" type="text" class="formfld" id="target" size="20" value="<?=htmlspecialchars($nat->target);?>">
                    <br>
