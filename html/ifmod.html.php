...
// -->
 		  ...
 		  <select name="iface" class="formfld" id="iface">
		     <?php
				...
				foreach($ifaces as $name => $desc) {
					?>
					<option value="<?=$name;?>" <?php if ($name == $if->if) echo "selected"; ?>><?=$desc;?></option>
					<?php
				}
			?>
		  </select>
		...
		<tr>	
                  ...
                  <td width="78%" class="vtable"> 
                    <input name="ipaddr" type="text" class="formfld" id="ipaddr" size="20" value="<?=htmlspecialchars($if->ipaddr);?>" onchange="ipaddr_change()">
                    / 
                    <select name="subnet" class="formfld" id="subnet">
                      <?php for ($i = 31; $i > 0; $i--): ?>
                      <option value="<?=$i;?>" <?php if ($i == $if->subnet) echo "selected"; ?>>
                      <?=$i;?>
                      </option>
                      <?php endfor; ?>
                    </select></td>
		...
		<?php if (isset($iid) && $iid && isset($if) && $if) { ?>
                  <input name="iid" type="hidden" value="<?=$if->id;?>">
 		  ...
 		  <select name="iface" class="formfld" id="iface">
			...
			?>
                ...
                <tr> 
                  ...
                  <td class="vtable"> <input name="spoofmac" type="text" class="formfld" id="spoofmac" size="30" value="<?=htmlspecialchars($if->spoofmac);?>"> 
                    <br>
                ...
                <tr> 
                  ...
                  <td class="vtable"> <input name="mtu" type="text" class="formfld" id="mtu" size="8" value="<?=htmlspecialchars($if->mtu);?>"> 
                    <br>
                ...
                <tr> 
                  ...
                  <td class="vtable"><input name="ipaddr" type="text" class="formfld" id="ipaddr" size="20" value="<?=htmlspecialchars($if->ipaddr);?>">
                    / 
                    <select name="subnet" class="formfld" id="subnet">
                    <?php
                     $snmax = 31;
                ...
                <tr> 
                  ...
                  <td class="vtable"><input name="gateway" type="text" class="formfld" id="gateway" size="20" value="<?=htmlspecialchars($if->gateway);?>"> 
                  </td>
                </tr>
                <tr> 
                  <td colspan="2" valign="top" height="16"></td>
                ...
                <tr> 
                  ...
                  <td class="vtable"> <input name="dhcphostname" type="text" class="formfld" id="dhcphostname" size="40" value="<?=htmlspecialchars($if->dhcp);?>">
                    <br>
...
<input name="enable" type="checkbox" value="yes" <?php if ($if->enable) echo "checked"; ?> onClick="enable_change(false);bridge_change(false)">
                    <strong>Enable Optional <?=$if->num;?> interface</strong></td>
				</tr>
                <tr> 
                  <td width="22%" valign="top" class="vncell">Description</td>
                  <td width="78%" class="vtable"> 
                    <input name="descr" type="text" class="formfld" id="descr" size="30" value="<?=htmlspecialchars($if->description);?>">
				...
				<tr> 
                  ...
                  <td width="78%" class="vtable">
					...
					foreach ($opts as $opt => $optname): ?>
                      <option <?php if ($opt == $if->bridge) echo "selected";?> value="<?=htmlspecialchars($opt);?>"> 
                ...
                <tr> 
                  ...
                  <td width="78%" class="vtable"> 
                	...
                	<select name="subnet" class="formfld" id="subnet">
					<?php for ($i = 31; $i > 0; $i--): ?>
					<option value="<?=$i;?>" <?php if ($i == $if->subnet) echo "selected"; ?>><?=$i;?></option>
					<?php endfor; ?>
                    </select>
				 </td>
				</tr>
