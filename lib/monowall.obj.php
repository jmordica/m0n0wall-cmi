...
//				"pptp" => "string:",
//				"bigpond" => "string:",
//				"dyndns" => array( 	"type" => "string:dyndns",
//							"username" => "string:",
//							"password" => "string:",
//							"host" => "string:",
//							"mx" => "string:",
...
//						),
//				"dnsupdate" => "string:",
//				"dhcpd" => array( "lan" => array( "range" => array(	"from" => "string:192.168.1.100",
//											"to" => "string:192.168.1.199"
//										),
//								  "defaultleasetime" => "string:",
//								  "maxleasetime" => "string:"
//								)
//						),
//				"pptpd" => array( 	"mode" => "string:",
//							"redir" => "string:",
//							"localip" => "string:",
//							"remoteip" => "string:"
//						),
//				"dnsmasq" => array(	"enable" => "string:" ),
				"snmpd" => "obj:snmp",
//				"diag" => array( "ipv6nat" => array("ipaddr" => "string:") ),
//				"bridge" => "string:",
				"syslog" => "obj:syslog",
				"nat" => array(		
