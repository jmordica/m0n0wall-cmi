...
<?php endif; ?>
 ...
 <?php endif; ?>
 <?php if (isset($form["bid"])): ?>
 <input type="hidden" name="action" value="<?php echo $bid; ?>">
 <?php endif; ?>

 <table width="100%" border="0" cellpadding="6" cellspacing="0">
 <tr>
  <td width="22%" valign="top" class="vncellreq">Username</td>
  <td width="78%" class="vtable"><input name="username" type="text" class="formfld" id="username" size="40" value="<?php echo $form["username"]; ?>">
 ...
 <tr>
  ...
  <td width="78%" class="vtable"><textarea name="description" class="formfld" id="description" size="40"><?php echo $form["description"]; ?></textarea>
